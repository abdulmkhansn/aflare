...
export const cardClassName =
  "rounded-lg border border-border-subtle bg-surface-card p-5";

export const emptyStateClassName =
  "rounded-lg border border-border-subtle bg-surface-card p-6 text-sm text-fg-muted";
...
export const fieldClassName = `w-full rounded-md border border-border-subtle bg-surface-input px-3 py-2 text-sm text-fg outline-none transition-shadow placeholder:text-fg-muted ${focusRingClassName}`;
...
export const secondaryButtonClassName = `cursor-pointer rounded-md border border-border-subtle bg-surface-card px-4 py-2.5 text-sm font-medium text-fg outline-none transition-colors hover:bg-[var(--hover-subtle)] ${focusRingClassName}`;
...
export const interactiveCardLinkClassName = `block cursor-pointer rounded-lg border border-border-subtle bg-surface-card p-4 outline-none transition-colors hover:border-fg/20 ${focusRingClassName}`;

export const headerSearchClassName = `w-full rounded-md border border-border-subtle bg-surface-input px-3 py-2 text-sm text-fg outline-none placeholder:text-fg-muted disabled:cursor-not-allowed disabled:opacity-70 ${focusRingClassName}`;
