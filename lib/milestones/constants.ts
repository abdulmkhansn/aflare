...
/** Compact labels for the build journey rail. */
...
export const MILESTONE_CELEBRATION_COPY: Record<MilestoneType, string> = {
  ...
  first_ship: "First ship. Something you made is out in the world.",
  first_flare: "First flare sent. Asking for help counts.",
